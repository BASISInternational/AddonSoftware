...
rem --- Set default Warehouse
	...
	callpoint!.setColumnData("OPR_SHIPPINGR.WAREHOUSE_ID",whse$,1)
	if callpoint!.getDevObject("multi_whse")<>"Y" then callpoint!.setColumnEnabled("OPR_SHIPPINGR.WAREHOUSE_ID",0)
