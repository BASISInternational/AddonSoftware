...
rem --- Set default Warehouse
	...
	callpoint!.setColumnData("IVR_POREQS.WAREHOUSE_ID",whse$,1)
	if callpoint!.getDevObject("multi_whse")<>"Y" then callpoint!.setColumnEnabled("IVR_POREQS.WAREHOUSE_ID",0)
