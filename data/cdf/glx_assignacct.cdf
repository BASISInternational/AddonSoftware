[[GLX_ASSIGNACCT.<CUSTOM>]]
#include [+ADDON_LIB]std_functions.aon
[[GLX_ASSIGNACCT.GL_ACCOUNT.AVAL]]
...
[[GLX_ASSIGNACCT.GL_WILDCARD.AVAL]]
...
[[GLX_ASSIGNACCT.ASVA]]
rem --- Ending account may not precede beginning account
beg$=callpoint!.getColumnData("GLX_ASSIGNACCT.GL_ACCOUNT_01")
end$=callpoint!.getColumnData("GLX_ASSIGNACCT.GL_ACCOUNT_02")
if cvs(end$,2)<>"" and cvs(beg$,2)<>"" and end$<beg$ then
	msg_id$="GL_ACCT_RANGE"
	gosub disp_message
	callpoint!.setStatus("ABORT")
endif
