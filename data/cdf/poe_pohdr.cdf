...
whse_addr_info: rem --- get and display Warehouse Address Info when not a dropship
	...
	if callpoint!.getColumnData("POE_POHDR.DROPSHIP")<>"Y" then
		...
		callpoint!.setColumnData("<<DISPLAY>>.W_ADDR3",ivc_whsecode$.addr_line_3$,1)
		callpoint!.setColumnData("<<DISPLAY>>.W_ADDR4","",1)
...
if callpoint!.getColumnData("POE_POHDR.DROPSHIP")="Y"
	...
	util.changeControlLabel(SysGUI!, callpoint!, "POE_POHDR.WAREHOUSE_ID", dropship_to$+":")
else
	ship_to_whse$=Translate!.getTranslation("AON_SHIP-TO")+" "+Translate!.getTranslation("AON_WAREHOUSE")
	util.changeControlLabel(SysGUI!, callpoint!, "POE_POHDR.WAREHOUSE_ID", ship_to_whse$+":")
endif
